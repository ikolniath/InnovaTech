...
Aplicacion para gestionar pedidos de una panificadora industrial. El proyecto evoluciono desde una version con almacenamiento en JSON hacia una aplicacion Express modular con MongoDB, Mongoose, autenticacion por sesiones, vistas Pug y Bootstrap.


→ Tenemos el uso integrado de:
...
bash
pnpm install
(Usamos pnpm por un tema de seguridad)
