//Importamos path para trabajar con rutas y http para compartir Express con Socket.IO
...
async function startServer() {
  ...
  //Configuramos Socket.IO sobre el mismo servidor HTTP cuando la app se inicia realmente
